...
public class MeetingsRepositoryImpl implements MeetingRepository{

    private MeetingsJpaRepository meetingsJpaRepository;

    public MeetingsRepositoryImpl(MeetingsJpaRepository meetingsJpaRepository){
    ...
    @Override
    public Long getTotalMeetingByCollaboratorId(UUID collaboratorId) {
        Specification<Meetings> spec = Specification.where(
            MeetingSpecification.collaboratorIdEquals(collaboratorId)
        );
        return meetingsJpaRepository.countMeetingsByCollaboratorId(collaboratorId, spec);
    }
}
